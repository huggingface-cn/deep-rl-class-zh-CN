...
# 第 3 单元: 用 RL Baselines3 Zoo 进行深度 Q 学习来玩 Atari 游戏 👾  
...
🔲 📚 **[学习第 3 单元的深度 Q 学习 ](https://huggingface.co/deep-rl-course/unit3/introduction)**  🤗

我们会持续提升我们的教程质量，如果你在本 notebook 中发现了什么问题请 [在 Github Repo 上提出 issue](https://github.com/huggingface/deep-rl-class/issues)。
