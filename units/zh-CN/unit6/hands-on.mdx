# 利用 PyBullet 和 Panda-Gym 进行机器人模拟的 **优势动作评论算法** (A2C) 🤖[[hands-on]]
...
现在您已经研究了 **优势动作评论算法** (A2C) 背后的理论，**您已准备好在机器人环境中使用 Stable-Baselines3 训练您的 A2C 智能体**。 并训练两个机器人：
...
# 第 6 单元：利用 PyBullet 和 Panda-Gym 进行机器人模拟的 **优势动作评论算法** (A2C) 🤖
