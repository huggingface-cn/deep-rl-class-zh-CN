# **优势动作评论算法**（A2C)[[advantage-actor-critic]]

## 使用动作评论算法减少方差

减少强化学习算法的方差并更快更好地训练我们的智能体的解决方案是结合使用基于策略和基于价值的方法：*动作评论算法*。

要了解*动作评论算法*，请想象您玩电子游戏。 你可以和一个朋友一起玩，他会给你一些反馈。 此种情况下，你是演员，你的朋友是评论家。
...
这就是“动作评论算法”方法背后的理念。我们学习了两个函数近似:
