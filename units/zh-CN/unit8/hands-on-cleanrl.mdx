...
现在我们已经学习了 PPO 的理论知识，最好的理解方法 **就是从头开始实现他**。
从头实现一个架构是理解他的最佳方式，这也是一个好习惯。我们已经用 Q 学习实现了基于价值的方法，用强化算法实现了基于策略的方法。
...
LunarLander-v2 是你在开始本课程时使用的第一个环境。当时，你并不知道他是如何工作的，现在你可以从头开始编写代码并训练他了。**这是多么令人难以置信的事情呀🤩。**
...
下一章节我们将会训练智能体玩 Doom，期待在第8单元第2部分与你相见 🔥
